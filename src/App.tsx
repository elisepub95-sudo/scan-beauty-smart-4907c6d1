...
import BeautyDiagnostic from "./pages/BeautyDiagnostic";
import BeautyDiagnosticResults from "./pages/BeautyDiagnosticResults";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/diagnostic/beaute" element={<BeautyDiagnostic />} />
          <Route path="/diagnostic/beaute/resultats" element={<BeautyDiagnosticResults />} />
